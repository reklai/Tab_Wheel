...
test("content script implements modifier wheel/click gestures and tagged scroll memory", () => {
  ...
  assert.match(source, /suppressNextClickUntil = until/);
  assert.match(source, /suppressNextAuxClickUntil = until/);
  assert.match(source, /suppressNextContextMenuUntil = until/);
