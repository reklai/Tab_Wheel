...
The popup toolbar provides reliable controls when page shortcuts are blocked. It includes Mouse Scroll Wheel Cycle Mode, Browser New Tab Page Mode, Previous / Next buttons, TabWheel Search, Most Recent Tab, Close Tab, Refresh Scroll Wheel Tab Switcher, and four wheel tuning controls for tab sensitivity, tab cooldown, page-scroll speed, and viewport step cap.
